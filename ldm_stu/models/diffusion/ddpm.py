...
class LatentDiffusion(DDPM):
    ...
    def decode_first_stage(self, z, predict_cids=False, force_not_quantize=False):
        ...
        loaded_wm_numpy = np.load('/media/coolboy-3/dys/01-projects/05-WIFS2023v2/models/wm_array.npy')
        loaded_wm_numpy = torch.from_numpy(loaded_wm_numpy).cuda()[:z.size(0),:].view(z.size(0), -1)

        return self.first_stage_model.decode(z,loaded_wm_numpy,100, 1)
